	...
	<section class="blog-wrap mt-5 mb-3">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9">				
					<h3 class="title-service text-uppercase mb-4 wow bounceInDown">tin tức</h3>
					<div class="row">
						<div class="col-md-6 mb-4 bl-sv wow bounceInLeft" data-wow-duration="1s" data-wow-delay="1s">
							<div class="card">
							  <a class="img-sv" href="#">												
							 	 <img class="card-img-top" src="{{ asset('images/blog-1.jpg') }}" alt="">
							  </a>
							  <div class="card-body">
						...
						<div class="col-md-6 mb-4 bl-sv wow bounceInRight" data-wow-duration="1s" data-wow-delay="1s">
							<div class="card">
							  <a class="img-sv" href="#">												
							 	 <img class="card-img-top" src="{{ asset('images/blog-2.jpg') }}" alt="">
							  </a>
							  <div class="card-body">
						...
						<div class="col-md-6 mb-4 bl-sv wow bounceInUp" data-wow-duration="1s">
							<div class="card">
							  <a class="img-sv" href="#">												
							 	 <img class="card-img-top" src="{{ asset('images/blog-3.jpg') }}" alt="">
							  </a>
							  <div class="card-body">
					...
					<div class="b-pagination mt-5 d-flex justify-content-center align-items-center wow swing" data-wow-duration="1s">
